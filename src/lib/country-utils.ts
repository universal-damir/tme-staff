...
const NATIONALITY_ALIAS_TO_CANONICAL: Record<string, string> = {
  ...
  'irish': 'Ireland',
  'greek': 'Greece',
  // Official self-designations as printed in the passport's own language.
  // These are NOT demonyms, so they miss both the exact and the
  // case-insensitive pass — a Greek passport prints 'HELLENIC', never
  // 'Greece', and used to leave the dropdown silently blank.
  'hellenic': 'Greece',
  'hellenic republic': 'Greece',
  'british citizen': 'United Kingdom',
  'british subject': 'United Kingdom',
